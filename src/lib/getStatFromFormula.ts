export const HPFormula = (base_stat: number, level: number = 100, ev: number = 252, iv: number = 31) =>
    CommonStatFormula(base_stat, level, ev, iv) + level + 10;

export const StatFormula = (base_stat: number, level: number = 100, ev: number = 252, iv: number = 31, nature: number = 1.1) =>
